...
the "Preserve approval gates" invariant. `phase-iterate` uses default auto-accept; `phase-scope`
instead presents the proposal and waits for approval before accepting.
