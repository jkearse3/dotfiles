...
review methods that provide meaningful evidence, expanding when risk, uncertainty, or broader
effects warrant it.
...
Before finishing, inspect the result for unintended effects, incomplete updates, and inconsistencies
with related material or state. Report how the result was assessed and any checks or review methods
that were skipped, blocked, or failed.
